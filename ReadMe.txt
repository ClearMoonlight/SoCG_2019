1. The folder Data includes two subfolders:
   (1)MNIST has three subfolders
      1>Gray is original dataset (n,d);
	  2>JL is dimensionality reduction dataset (n,d/4), (n,d/8) and (n,d/16);
	  3>k-center is k-center dataset;
   (2)Caltech has four subfolders
      1>Code is the preprocessing code;
	  2>VGG is original dataset (n,d);
      3>JL is dimensionality reduction dataset (n,d/4), (n,d/8) and (n,d/16);
	  4>k-center is k-center dataset.
